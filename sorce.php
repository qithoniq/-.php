...
[
 'chat_id'=>$chat_id,
"photo=>"https://t.me/qithom/5",
'parse_mode'=>"MARKDOWN",
'caption'=>"❪Welcome to source qithon )
( AhMeD Mustafa )
( dev - @lsbax_dev)", 'reply_to_message_id'=>$message_id,
  'parse_mode'=>"markdown",
  'reply_markup'=>json_encode([
     'inline_keyboard'=>[
     [['text'=>"Source channel",'url'=>"https://t.me/QITHON" ]],
       [['text'=>"Source updates",'url'=>"https://t.me/updateqi" ]],
       [['text'=>"Source programmer",'url'=>"https://t.me/lsbax_dev" ]],
       [['text'=>"Sourse Maker",'url'=>"https://t.me/TOBLN_bot" ]],
      ]
    ])
]);
$sorceu = file_get_contents("data/sorceu.json");
